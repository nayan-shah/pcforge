        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_360px] lg:items-end">
          <div>
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-300">
              Compare parts, prices, and availability for your next PC.
            </p>
          </div>
        ...
        <div className="space-y-6">
          {!isLoading && !error && data && (
            <p className="text-sm text-slate-500 dark:text-slate-400">
              {data.totalCount} component{data.totalCount === 1 ? '' : 's'} found
            </p>
          )}
          {isLoading ? (
            ...
            <div className="rounded-3xl border border-rose-200 bg-rose-50 p-10 text-center dark:border-rose-900 dark:bg-rose-950/30">
              ...
              <h2 className="mt-4 text-lg font-semibold text-rose-800 dark:text-rose-200">
              ...
              <button
                type="button"
                onClick={retry}
                className="mt-5 inline-flex items-center gap-2 rounded-xl bg-rose-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-rose-500"
              >
                <HiOutlineArrowPath className="h-4 w-4" /> Retry
              </button>
            </div>
